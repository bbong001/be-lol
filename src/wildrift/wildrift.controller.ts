...
export class WildriftController {
  ...
  findAllChampions(@Query('role') role?: string) {
    return this.wildriftService.findAllChampions(role);
  }
  ...
  findAllItems() {
    return this.wildriftService.findAllItems();
  }
  ...
  findAllGuides(@Query('championId') championId?: string) {
    return this.wildriftService.findAllGuides(championId);
  }
